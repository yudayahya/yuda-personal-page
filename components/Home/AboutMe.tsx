        ...
        <>
            <section className='pt-20 px-6 w-full' id='about-me'>
                ...
                <p className='text-center text-custom-black-300 text-lg py-6'>
                    ...
                    Whenever possible I expand my knowledge about <span className='text-blue-400'>Laravel</span>, <span className='text-blue-400'>Codeigniter</span>, <span className='text-blue-400'>Django</span>, <span className='text-blue-400'>Express.js</span>, <span className='text-blue-400'>Nest.js</span>, <span className='text-blue-400'>Nuxt.js</span>, <span className='text-blue-400'>Next.js</span>, <span className='text-blue-400'>Vue.js</span>, <span className='text-blue-400'>React.js</span>, <span className='text-blue-400'>Svelte.js</span>, and <span className='text-blue-400'>Flutter</span>.
                </p>
