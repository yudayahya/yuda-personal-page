            ...
            <div className="py-36 h-[1050px] sm:h-[950px] relative">
                ...
                <div className="absolute z-10 mx-auto inset-x-0">
                    <p className="text-center text-8xl sm:text-[140px] font-black tracking-tighter cursor-default select-none">
                        <span
                            className="transition-colors duration-[1500ms] ease-in-out bg-clip-text gradient-first"
                            style={firstTagLineClass}
                        >
                            Aziiza.
                        </span>
                    </p>
                    <p className="text-center text-8xl sm:text-[140px] font-black tracking-tighter cursor-default select-none my-2">
                        <span
                            className="transition-colors duration-[1500ms] ease-in-out bg-clip-text gradient-second"
                            style={secondTagLineClass}
                        >
                            Yuda.
                        </span>
                    </p>
                    <p className="text-center text-8xl sm:text-[140px] font-black tracking-tighter cursor-default select-none">
                        <span
                            className="transition-colors duration-[1500ms] ease-in-out bg-clip-text gradient-third"
                            style={thirdTagLineClass}
                        >
                            Yahya.
                        </span>
                    </p>
                    <div className="hidden sm:block">
                        <div className="flex justify-center items-center mt-14 font-medium">
                            <a href="#about-me" className="w-48 p-px mx-4 rounded-md bg-white group">
                                <div className="rounded-md h-11 flex justify-center items-center bg-white text-custom-black-900 group-hover:bg-custom-black-900 group-hover:text-white transition-all ease-in-out duration-500">
                                    Get Started
                                </div>
                            </a>
                            <a
                            ...
                            >
                                <div
                                    className={
                                        'w-full h-[46px] rounded-md absolute transition-opacity duration-[1500ms] ease-in-out bg-gradient-to-br from-blue-800 to-cyan-400 ' +
                                        buttonFirstGradient
                                    }
                                ></div>
                                <div
                                    className={
                                        'w-full h-[46px] rounded-md absolute transition-opacity duration-[1500ms] ease-in-out bg-gradient-to-tr from-purple-700 to-pink-500 ' +
                                        buttonSecondGradient
                                    }
                                ></div>
                                <div
                                    className={
                                        'w-full h-[46px] rounded-md absolute transition-opacity duration-[1500ms] ease-in-out bg-gradient-to-r from-orange-700 to-yellow-400 ' +
                                        buttonThirdGradient
                                    }
                                ></div>
                                <div
                                ...
                                <div className="w-[190px] h-11 rounded-md absolute top-px left-px flex justify-center items-center bg-custom-black-900 text-white opacity-100 group-hover:opacity-0 transition-all ease-in-out duration-500">
                                    See My Resume
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <div className="mt-10 font-medium text-sm w-11/12">
                                <a href="#about-me" className="block max-w-sm p-px my-5 rounded-md bg-white mx-auto">
                                    <div className="rounded-md h-[36px] flex justify-center items-center bg-white text-custom-black-900">
                                        Get Started
                                    </div>
                                </a>
                                <a
                    ...
                    <div className="w-full h-20 mt-16 px-6">
                        <p className="text-center text-custom-black-300 text-xl">
                            Hi there!👋🏻 <br />
                            I&apos;m Yuda, Bachelor of Computer Science, Software Engineer at amalan International
                            Indonesia. <br />
                            🧑‍💻 I&apos;m currently working on development web, mobile, and desktop applications,
                            Full-stack.
                        </p>
                    </div>
                </div>
