    ...
    return (
        <>
            <section className="pt-20 px-6 w-full" id="my-journey">
                ...
                <p className="text-center text-white text-6xl tracking-tighter font-bold">
                    Let Me Tell You About My Journey
                </p>
                <p className="text-center text-custom-black-300 text-lg py-6">
                    I was born in Madiun, Indonesia. <br />
                    After <span className="text-custom-pink-600">graduated</span> from high school, I decided to{' '}
                    <span className="text-custom-pink-600">study</span> in Yogyakarta, Indonesia, <br />
                    majored in <span className="text-custom-pink-600">informatics engineering</span>. From here my
                    journey begins...
                </p>
                <div className="w-full flex justify-center items-center cursor-default">
                    <div className="w-full grid grid-cols-1 py-8">
                            ...
                            <div className="h-28 border-l border-custom-black-300">
                                ...
                                >
                                    <div className="w-max">
                                        ...
                                        <p className="text-custom-black-300 text-lg">
                                            Start my journey to learn{' '}
                                            <span className="text-custom-pink-600">Programming</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="h-44 border-l border-dashed border-custom-black-300 mx-auto relative">
                            ...
                            >
                                <div className="w-max">
                                    ...
                                    <p className="text-custom-black-300 text-lg text-right">
                                        Start working as a <span className="text-custom-pink-600">Freelancer</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="absolute top-40 left-6 overflow-x-scroll scrollbar-hide" style={maxWidth}>
                                <div className="w-max">
                                    ...
                                    <p className="text-custom-black-300 text-lg">
                                        ...
                                        <span className="text-custom-pink-600">Computer Science</span>
                                    </p>
                                    <p className="text-custom-black-300 text-lg">
                                        Working at <span className="text-custom-pink-600">amalan International</span> as
                                        a <span className="text-custom-pink-600">Backend Engineer</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-44 border-l border-dashed border-custom-black-300 mx-auto relative">
                            ...
                            >
                                <div className="w-max">
                                    ...
                                    <p className="text-custom-black-300 text-lg text-right">
                                        Working at <span className="text-custom-pink-600">amalan International</span> as
                                        a <span className="text-custom-pink-600">Fullstack Engineer</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center items-center text-lg font-semibold text-custom-black-900 h-10 w-10 rounded-full mx-auto gradient-third">
                            3
                        </div>
                        <p className="text-center text-3xl font-bold bg-clip-text text-transparent mt-6 tracking-tighter gradient-third">
                            Projects
                        </p>
                    </div>
                </div>
